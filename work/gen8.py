...
export default function ExerciseDetail({ exercise, onClose, onCompare, isComparing }: Props) {
  ...
  const langLabels: Record<string, string> = { zh: '\\u4e2d\\u6587', en: 'English', tr: 'Turkish', es: 'Spanish', ru: 'Russian', fr: 'French', de: 'German', it: 'Italian', ko: 'Korean', hi: 'Hindi', pl: 'Polish' };
  return (
      ...
      <div style={s.modal} onClick={e => e.stopPropagation()}>
        ...
        <div style={s.header}>
          <div style={s.headerTop}>
            <span style={s.badge}>{bpEmoji[exercise.body_part] || '\\ud83c\\udfcb\\ufe0f'} {exercise.body_part}</span>
        ...
        <div style={s.body}>
          ...
          <div style={s.instructionsSection}>
            <div style={s.langTabs}>
              {['zh', 'en'].map(l => (
                <button key={l} onClick={() => setLangTab(l as any)}
